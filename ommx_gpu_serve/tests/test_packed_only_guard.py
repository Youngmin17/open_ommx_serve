...
def canonical_recipe(monkeypatch):
    ...
    from the one every published measurement used. These five knobs are the recipe
    ...
    from. relidx7 is explicit because the accounting now defaults to the serving
    encoding (bitmap, 8.250).
    """
    monkeypatch.setenv("OMMX_ATTN_OUTLIER_REPR", "relidx7")
