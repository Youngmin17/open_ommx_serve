...
"""
# No `from __future__ import annotations` here: torch.library.custom_op reads the
# annotations at import time and torch < 2.5 cannot resolve them when they are strings.
