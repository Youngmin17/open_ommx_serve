...
# The derived symbols are LlamaRMSNorm, LlamaMLP, rotate_half, apply_rotary_pos_emb,
# repeat_kv and eager_attention_forward. OMMX modifications: Copyright (c) 2024-2026,
# OMMX Contributors, under the same licence. See THIRD_PARTY.md.
#
