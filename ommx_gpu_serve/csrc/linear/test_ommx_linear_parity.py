...
"""OMMX linear — fakequant-consistency PARITY gate (correctness before latency).

Authored on a no-GPU host (the kernel math is GPU-deferred); this is the TURNKEY gate to
run FIRST, BEFORE any latency/bench. It:
