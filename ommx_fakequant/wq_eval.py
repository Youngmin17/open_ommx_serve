...
def main():
    ...
    # KV-sensitivity probe E0: dump per-layer score_K / e_o (OMMX_SPARSE_SCORE_OUT). The probe caps at
    ...
    # on the calib-bake prefill forwards. Consumed by the offline outlier-profile builder.
