...
PY_OMMX=/scratch/<user>/conda_envs/ommx/bin/python
D=/scratch/<user>/fig7/open_ommx_serve/figure/data_h200canon
"$PY_OMMX" /scratch/<user>/fig7/open_ommx_serve/ommx_gpu_serve/bench/e2e_to_figure.py \
...
cp -n /scratch/<user>/fig7/open_ommx_serve/figure/data_h200fig7/kivi_hf.json "$D/" 2>/dev/null
cp -n /scratch/<user>/fig7/open_ommx_serve/figure/data_h200fig7/lmdeploy.json "$D/" 2>/dev/null
